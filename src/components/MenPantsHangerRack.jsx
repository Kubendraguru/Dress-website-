        ...
        <div className="lg:col-span-5 xl:col-span-5 w-full bg-[#faf8f5] rounded-3xl p-5 sm:p-6 border border-neutral-200/90 shadow-md flex flex-col justify-between space-y-4">
          ...
          <div className="space-y-3.5 pt-1">
            ...
            <div className="flex items-baseline justify-between gap-4">
              ...
              <span className="text-xl sm:text-2xl font-medium text-neutral-950">₹{activePant.price.toFixed(2)}</span>
            </div>
              ...
              >
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="text-sm font-medium text-neutral-950 flex-shrink-0">₹{p.price.toFixed(2)}</span>
                  </div>
