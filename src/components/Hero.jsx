  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[1440px] h-[640px] sm:h-[700px] md:h-[780px] flex items-center justify-center px-4 sm:px-8 lg:px-12">
        ...
        {/* Right Side Luxury Department Card (Matches Mockup media_1789398310704.png) */}
        <div className="hidden md:block absolute right-3 sm:right-6 md:right-8 lg:right-12 top-[46%] -translate-y-1/2 z-30 pointer-events-auto">
          
          <div className="relative w-[280px] lg:w-[310px] bg-[#121214] text-white border border-neutral-800/90 rounded-2xl p-4 shadow-[0_25px_60px_rgba(0,0,0,0.6)] backdrop-blur-md">
            
            {/* 1. Header: Department Indicator & SS26 Tag */}
            <div className="flex items-center justify-between pb-3 mb-2 border-b border-neutral-800/80">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bebas text-sm sm:text-base tracking-[0.2em] text-neutral-200 uppercase font-semibold">
                  MEN&apos;S DEPARTMENT
                </span>
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <button
                ...
                className="w-full group p-2 rounded-xl flex items-center justify-between transition-all hover:bg-neutral-900 text-left cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-neutral-300 group-hover:border-neutral-700 transition-colors flex-shrink-0">
                    <ShoppingBag className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="flex items-center gap-1.5">
                      <span className="font-bebas text-sm sm:text-base tracking-wider text-white font-bold">
                        SHIRT
                      </span>
                      <span className="text-[9px] font-mono font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded bg-neutral-800 text-neutral-400 border border-neutral-700/60">
                        ATELIER
                      </span>
                    </div>
                    <p className="text-[11px] text-neutral-400 font-light leading-none pt-0.5">
                      Linen, Oxford &amp; Rib-Knit Polos
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-neutral-400 font-light leading-none pt-0.5">
                      Pleated Trousers &amp; Italian Chinos
                    </p>
                  </div>
                </div>
                <ArrowRight className="w-3.5 h-3.5 text-neutral-500 group-hover:text-white group-hover:translate-x-1 transition-all" />
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-neutral-400 font-light leading-none pt-0.5">
                      Graphic Series &amp; Heavyweight Tees
                    </p>
                  </div>
                </div>
                <ArrowRight className="w-3.5 h-3.5 text-neutral-500 group-hover:text-white group-hover:translate-x-1 transition-all" />
              ...
              {/* Row 4: COMBO (Highlighted with Gold Accent & 15% OFF Badge) */}
              <button
                onClick={() => setIsShopLookModalOpen(true)}
                className="w-full group p-2 rounded-xl flex items-center justify-between transition-all bg-amber-500/5 hover:bg-amber-500/10 border border-amber-500/20 text-left cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-amber-500/15 border border-amber-500/40 flex items-center justify-center text-[#fbbf24] shadow-[0_0_12px_rgba(245,158,11,0.25)] flex-shrink-0">
                    <Sparkles className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[9px] font-mono font-black uppercase tracking-wider px-1.5 py-0.5 rounded bg-[#fbbf24] text-black shadow-xs">
                        15% OFF
                      </span>
                    </div>
                    <p className="text-[11px] text-neutral-300 font-light leading-none pt-0.5">
                      Curated Head-to-Toe Look Sets
                    </p>
                  </div>
                </div>
            ...
            {/* 3. Bottom Button: EXPLORE ALL MEN'S → */}
            <button
              onClick={() => {
                window.location.hash = '#men';
                const el = document.getElementById('collections');
              ...
              className="w-full mt-3 py-2.5 px-4 rounded-xl bg-neutral-950 hover:bg-[#fbbf24] text-[#fbbf24] hover:text-black border border-neutral-800 hover:border-[#fbbf24] font-bebas text-sm sm:text-base tracking-[0.2em] font-bold flex items-center justify-center gap-2 transition-all duration-300 shadow-md cursor-pointer group"
            >
