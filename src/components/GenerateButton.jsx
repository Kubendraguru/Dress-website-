    ...
    <div className="relative inline-block group">
      <style>{`
        .gen-btn {
          ...
          font-family: "Space Mono", "Plus Jakarta Sans", monospace, sans-serif;
          font-size: 0.82rem;
          font-weight: 700;
          ...
          box-shadow:
            ...
            inset 0px 2px 2px rgba(255, 255, 255, 0.18),
            ...
            0px 14px 35px rgba(0, 0, 0, 0.45);

          border: solid 1px rgba(255, 255, 255, 0.2);
          border-radius: var(--border-radius);
          cursor: pointer;

          transition: box-shadow var(--transition), border var(--transition), background-color var(--transition), transform 0.25s ease;
        }
        ...
        .gen-btn-letter {
          ...
          animation: gen-letter-anim 2.5s ease-in-out infinite;
        ...
        .gen-btn[data-generating="true"] .gen-btn-letter {
          animation: gen-focused-letter-anim 0.8s ease-in-out forwards, gen-letter-anim 1.2s ease-in-out infinite;
        ...
        @keyframes gen-focused-letter-anim {
          ...
          50% {
            transform: scale(1.4);
            filter: blur(4px) brightness(150%) drop-shadow(0 0 10px hsl(var(--highlight-color-hue), 100%, 70%));
          }
        }
        ...
        .gen-btn[data-generating="true"]::before {
          box-shadow: 0 -8px 12px -6px rgba(255,255,255,0.3) inset,
